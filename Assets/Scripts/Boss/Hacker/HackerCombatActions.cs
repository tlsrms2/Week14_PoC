...
namespace Week14.Enemy
{
    ...
    public sealed class HackerMeleeAttackAction : BossAction, IBossActionDurationProvider, IHackerApproachRangeProvider
    {
        ...
        public override IEnumerator Execute(BossActionContext context)
        {
            ...
            try
            {
                context.PlaySfx(SoundEvent.Hacker_BeforeAttack);
                ...
                context.PlaySfx(GetAttackSoundId(wasParried));
        ...
        private SoundEvent GetAttackSoundId(bool wasParried)
        {
            if (wasParried)
            {
                return SoundEvent.Hacker_SlashMiss;
            }

            return style switch
            {
                HackerMeleeAttackStyle.Lift => SoundEvent.Hacker_Lift,
                HackerMeleeAttackStyle.Slam => SoundEvent.Hacker_Slam,
                _ => SoundEvent.Hacker_Slash
            };
        }
    ...
    public class HackerThrustAction : BossAction, IBossActionDurationProvider, IHackerApproachRangeProvider
    {
        ...
        public override IEnumerator Execute(BossActionContext context)
        {
            ...
            context.PlaySfx(wasParried
                ? SoundEvent.Hacker_SlashMiss
                : SoundEvent.Hacker_Slam);
