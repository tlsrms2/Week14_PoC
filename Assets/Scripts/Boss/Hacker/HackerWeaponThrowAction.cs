...
namespace Week14.Enemy
{
    ...
    public sealed class HackerWeaponThrowAction : BossAction, IBossActionDurationProvider
    {
        ...
        [FormerlySerializedAs("landingSfxId")]
        [SerializeField, BossGraphSfxId] private string throwSfxId = HackerSfxIds.PutTurret;
        ...
        public override IEnumerator Execute(BossActionContext context)
        {
            ...
            weapon.ThrowTo(
                ...
                flyingSprite,
                groundedSprite);
            context.PlaySfx(HackerSfxIds.Resolve(throwSfxId, HackerSfxIds.PutTurret));
