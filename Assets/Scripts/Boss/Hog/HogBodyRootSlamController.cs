...
{
    internal sealed class HogBodyRootSlamController
    {
            ...
            Action stop)
        {
            ...
            HogPatternEffects.PlayExplosionIfEnabled(settings.Effects, target.position);
            HogPatternEffects.PlayCameraShakeIfEnabled(settings.Effects, Vector2.down);
        }
