...
[CustomEditor(typeof(MuscleBossAI))]
[CanEditMultipleObjects]
public sealed class MuscleBossAIEditor : Editor
{
    ...
    private static readonly HashSet<string> MuscleFields = new()
    {
        "bossGraph",
        "graphProjectiles"
    };
    ...
    private void DrawBossGraphSection()
    {
        ...
        {
            EditorGUILayout.HelpBox("Boss Graph가 비어 있으면 MuscleBossAI는 패턴을 실행하지 않습니다.", MessageType.Warning);
        }
    ...
    {
        return targets.Length == 1 && target is MuscleBossAI boss ? boss.transform : null;
    }
    ...
    private void DrawBaseProperties()
    {
        ...
        while (property.NextVisible(enterChildren))
        {
            ...
            if (IsPropertyNamed(property, "m_Script")
                || ContainsPropertyName(MuscleFields, property)
