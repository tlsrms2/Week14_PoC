...
{
    /// <summary>
    /// 적 공격 타임라인. 발사 시점과 이벤트별 패턴만 정의하고, 투사체 수치는 EnemyData에서 관리한다.
    /// </summary>
    ...
    {
        [Tooltip("공격 패턴 표시 이름입니다. 비워두면 에셋 이름을 사용합니다.")]
        [SerializeField] private string timelineName;

        [Tooltip("이 패턴이 끝난 뒤 다음 공격까지 기다리는 시간입니다.")]
