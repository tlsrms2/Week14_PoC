...
namespace Week14.UI
{
    public class BulletBarView : MonoBehaviour
    {
        ...
        private void SetValue(int current, int max, bool animate)
        {
            ...
            ResizeVisibleIcons(visibleCount, animate && changed, gained, source);
        ...
        private Color ResolveEffectColor(BulletChangeSource source)
        {
            return source switch
            {
                ...
                BulletChangeSource.Defense => defenseOutlineColor,
        ...
        private void ApplyPlayerConfigColors()
        {
            ...
            defenseOutlineColor = config.BulletDefenseOutlineColor;
            ...
            public bool Tick(float deltaTime)
            {
                ...
                switch (animationKind)
                {
                    case IconAnimationKind.Spawn:
                        ...
                        Rect.localRotation = Quaternion.Lerp(Rect.localRotation, Quaternion.identity, t);
                    ...
                    case IconAnimationKind.Hit:
                        ...
                        Rect.localRotation = Quaternion.Euler(0f, 0f, shake);
                        Image.color = Color.Lerp(effectColor, BaseColor, t);
                        break;
