...
namespace Week14.UI
{
    public sealed class HoverSoundSource : MonoBehaviour, IPointerEnterHandler, IPointerClickHandler
    {
        ...
        {
            if (selectable is Button button && button.interactable)
            {
                SoundManager.PlayButtonClickSfx();
            }
        }
    }
}
